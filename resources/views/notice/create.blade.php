...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form method="POST" action="{{ route('notice.store') }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="form-group @if($errors->has('author')) has-danger @endif">
                            ...
                            @if($errors->has('author')) form-control-danger @endif"
                        ...
                        <div class="form-group @if($errors->has('title')) has-danger @endif">
                            ...
                            @if($errors->has('title')) form-control-danger @endif"
